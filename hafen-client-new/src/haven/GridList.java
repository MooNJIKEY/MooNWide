...
public abstract class GridList<T> extends Widget {
    public static final Text.Furnace dcatf = new BlurFurn(new TexFurn(new Text.Foundry(Text.serif.deriveFont(java.awt.Font.BOLD, (float)UI.scale(18.0))).aa(true), Window.ctex), 2, 1, new Color(54, 34, 22));
